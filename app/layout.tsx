...
import { Bonbon, Poppins } from 'next/font/google'
import "./globals.css";
...
export const metadata: Metadata = {
  ...
  title: "MMU Printing",
  description: "the best Printing service.",
  icons: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${bonbon.variable} ${poppins.variable} font-poppins  scroll-smooth antialiased`}
      >
        {children}
        <InstallPrompt />
      </body>
